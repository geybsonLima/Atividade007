...
@WebServlet("/AlterarFaturaServlet")
public class AlterarFaturaServlet extends HttpServlet {
	...
	private static final long serialVersionUID = 6307200982001552647L;
		...
		protected void service(HttpServletRequest req, HttpServletResponse res) 
			...
			if(erroConverter == false){
				...
				Faturadao dao2 = new Faturadao();
				dao2.alterar(fatura);
				
				out.println("<html>");
				out.println("<body>");
				out.println("Fatura" + Fatura.getNome() + " alterado com sucesso"");
				out.println("</body>");
				out.println("</html>");
